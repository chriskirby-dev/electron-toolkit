...
import FluxWindow from "../../Base/FluxWindow.mjs";

const HOMEPAGE_PATH = path.resolve(__dirname, "debug.html");
const PRELOAD_PATH = path.resolve(__dirname, "viewport.preload.mjs");

...
class ViewerWindow extends FluxBrowserWindow {
    static allowedOptions = ["width", "height", "dockTo"];
    static homepage = path.resolve(__dirname, "../views/viewer.html");
    ...
    dockTo(target, position, offset = { x: 0, y: 0 }) {
        this.docked = {
            search: target,
            position: position,
            offset: offset,
